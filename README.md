...
The code is written in C to test each of these subsystems with the use of Arduino Uno. Link to video demonstration of testing: https://youtu.be/zzs-VEquVlk
